    ...
    <>
      ...
      <div >
        <div style={{display:"flex", marginBottom:24,  justifyContent:"space-between", alignItems:"center"}}>
          <div >
            <h1 style={{ fontSize: 22, fontWeight: 800, color: C.text }}>Generate & Reprint Receipt</h1>
            <p style={{ fontSize: 13, color: C.muted, marginTop: 3 }}>View, download and print receipt</p>
          </div>
            ...
            >
              <div style={{ position: "relative", flex: 1 }}>
                ...
                <input
                  ...
                  placeholder="Search Using Patient ID..."
                  style={{
                    width: "100%",
                    height: 34,
